...
cdef class ToeholdTest:
    ...
    cdef:
        ...
        readonly (size_t, size_t) rbs_location
        ...
        readonly Py_ssize_t aug_location
    ...
    def __init__(self,
        ...
        self.rbs_location = rbs_location.start, rbs_location.stop
    ...
    def generate(self,
                 ...
                 int n_samples = 100,
                 int n_nodes = os.cpu_count(),
                 int n_chunks = os.cpu_count(),
                 bint safety_checks = True) -> Generator[ChunkResult]:
    ...
    cdef void _setup(self) except *:
        ...
        for i in range(self.rbs_location[1], len(self.ths)):
        ...
        self.meta = {"THS"                              :self.ths,
                     ...
                     "RBS"                              :self.ths[self.rbs_location[0]:self.rbs_location[1]],
    ...
    cdef inline void _check_safety(self) except *: #TODO: safety checks?
        # unfinished
    ...
    cdef inline bint _rbs_exposed(self, unicode ths_struct):
        ...
        cdef unicode rbs_struct = ths_struct[self.rbs_location[0]:self.rbs_location[1]]
        cdef int rbs_len = self.rbs_location[1] - self.rbs_location[0]
        return rbs_struct == ("." * rbs_len)
    
    cdef inline bint _aug_exposed(self, unicode ths_struct):
        """Test if aug is fully unbound"""
        return ths_struct[self.aug_location:self.aug_location+3] == "..."
    
    cdef inline bint _post_aug_exposed(self, unicode ths_struct):
        """Test for binding to previous regions based of DPP notation"""
        cdef unicode post_aug = ths_struct[self.aug_location+3:]
